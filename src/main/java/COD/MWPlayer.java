...
public class MWPlayer {
    ...
    public static class Commendation implements Comparable<Commendation> {
         ...
         */
        @Override
        public int compareTo(@NotNull MWPlayer.Commendation o) {
    ...
    public class Killstreak implements Comparable<Killstreak> {
         ...
         */
        @Override
        public int compareTo(@NotNull MWPlayer.Killstreak o) {
    ...
    public static class FieldUpgrade implements Comparable<FieldUpgrade> {
         ...
         */
        @Override
        public int compareTo(@NotNull MWPlayer.FieldUpgrade o) {
            return o.getUses() - getUses();
        }
